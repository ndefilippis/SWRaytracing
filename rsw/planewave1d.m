...
Xpin = .3*randn(np,1);
%Xpin = 0;
[U,ke,pe,time,Xp,t,ue] = sw1(Uin,x,f,Cg,15000,25,Xpin);


if makemov
    % movie of u, v and spectra of each
...
grid
set(gca,'fontsize',14)
title('Particle drift with f=1, C_g=1, k_0=6, a=.02, nx=256')
xlabel('t')
%legend('<X>','X_s','X_e','X_s+X_e','X_l (lin trend of mean(Xp))','a^2\omega/(2k_0f) (sin(ft)-t)','a^2\omega/(2k_0f) (sin(ft)-t)+X_s')
legend('<X>','X_s','X_e','X_s+X_e','location','southwest')
