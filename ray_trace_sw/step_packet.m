function [Pout] = step_packet(P,U,GradU,C0,f,dx,dy,dt)
    
% [Pout] = step_packet(P,U,GradU,C0,f,dx,dy,dt)
%
...
% dl/dt = -u_y k - v_y l 
% 
% (neglecting omega_x, omega_y and dependence of U, omega on t)  
%
...
u_xi = interpolate(P.x,P.y,GradU.u_x,dx,dy);
u_yi = interpolate(P.x,P.y,GradU.u_y,dx,dy);
v_xi = interpolate(P.x,P.y,GradU.v_x,dx,dy);
v_yi = interpolate(P.x,P.y,GradU.v_y,dx,dy);

% Step wavenumbers forward

k1 = dt*(-u_xi*P.k - v_xi*P.l);
l1 = dt*(-u_yi*P.k - v_yi*P.l);

k2 = dt*(-u_xi*(P.k+k1/2) - v_xi*(P.l+l1/2));
l2 = dt*(-u_yi*(P.k+k1/2) - v_yi*(P.l+l1/2));

k3 = dt*(-u_xi*(P.k+k2/2) - v_xi*(P.l+l2/2));
l3 = dt*(-u_yi*(P.k+k2/2) - v_yi*(P.l+l2/2));

k4 = dt*(-u_xi*(P.k+k3) - v_xi*(P.l+l3));
l4 = dt*(-u_yi*(P.k+k3) - v_yi*(P.l+l3));
